...
::: medium
<center>
Attributs associés aux géométries des régions européennes (GISCO)
</center>
:::
...
::: {.column width="49%"}
Données de population communales de l'INSEE
![](img/insee.png)
:::
:::
...
## Pour conclure... {.inverse background-color="black" .v-center-container}
